...
namespace Misaf\VendraBlogApi\Tests;
...
use Misaf\VendraBlogApi\JsonApi\V1\Server as VendraBlogServer;
use Misaf\VendraBlogApi\Providers\BlogApiServiceProvider;
...
abstract class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $app['config']->set('jsonapi.servers.vendra-blog', VendraBlogServer::class);
